...
<body>
  ...
  <div class="container">
    ...
    > <a href="/Exploration/user/game/view">Playing Game :
      ${gameTitle }</a> <br>
    <h2>${gameTitle }</h2>
    <hr />
            ...
            <tr>
              <td class="first score">
                <div class="form-item form-type-textfield form-item-frame1-1">
                    <input type="text" id="edit-frame1-1" name="frame1-1" value="0" size="1" maxlength="1" class="form-text" readonly />
                </div>
              </td>
              <td class="second score">
                <div class="form-item form-type-textfield form-item-frame1-2">
                  <input type="text" id="edit-frame1-2" name="frame1-2" value="0" size="1" maxlength="1" class="form-text" readonly />
                </div>
              </td>
              <td class="first score">
                <div class="form-item form-type-textfield form-item-frame2-1">
                  <input type="text" id="edit-frame2-1" name="frame2-1" value="0" size="1" maxlength="1" class="form-text" readonly />
                </div>
              </td>
              <td class="second score">
                <div class="form-item form-type-textfield form-item-frame2-2">
                  <input type="text" id="edit-frame2-2" name="frame2-2" value="0" size="1" maxlength="1" class="form-text" readonly />
                </div>
              </td>
              <td class="first score">
                <div class="form-item form-type-textfield form-item-frame3-1">
                  <input type="text" id="edit-frame3-1" name="frame3-1" value="0" size="1" maxlength="1" class="form-text" readonly />
                </div>
              </td>
              <td class="second score">
                  <div class="form-item form-type-textfield form-item-frame3-2">
                    <input type="text" id="edit-frame3-2" name="frame3-2" value="0" size="1" maxlength="1" class="form-text" readonly />
                  </div>
              </td>
              <td class="first score">
                  <div class="form-item form-type-textfield form-item-frame4-1">
                    <input type="text" id="edit-frame4-1" name="frame4-1" value="0" size="1" maxlength="1" class="form-text" readonly />
                  </div>
              </td>
              <td class="second score">
                  <div class="form-item form-type-textfield form-item-frame4-2">
                    <input type="text" id="edit-frame4-2" name="frame4-2" value="0" size="1" maxlength="1" class="form-text" readonly />
                  </div>
              </td>
              <td class="first score">
                  <div class="form-item form-type-textfield form-item-frame5-1">
                    <input type="text" id="edit-frame5-1" name="frame5-1" value="0" size="1" maxlength="1" class="form-text" readonly />
                  </div>
              </td>
              <td class="second score">
                  <div class="form-item form-type-textfield form-item-frame5-2">
                    <input type="text" id="edit-frame5-2" name="frame5-2" value="0" size="1" maxlength="1" class="form-text" readonly />
                  </div>
              </td>
              <td class="first score">
                  <div class="form-item form-type-textfield form-item-frame6-1">
                    <input type="text" id="edit-frame6-1" name="frame6-1" value="0" size="1" maxlength="1" class="form-text" readonly />
                  </div>
              </td>
              <td class="second score">
                  <div class="form-item form-type-textfield form-item-frame6-2">
                    <input type="text" id="edit-frame6-2" name="frame6-2" value="0" size="1" maxlength="1" class="form-text" readonly />
                  </div>
              </td>
              <td class="first score">
                  <div class="form-item form-type-textfield form-item-frame7-1">
                    <input type="text" id="edit-frame7-1" name="frame7-1" value="0" size="1" maxlength="1" class="form-text" readonly />
                  </div>
              </td>
              <td class="second score">
                  <div class="form-item form-type-textfield form-item-frame7-2">
                    <input type="text" id="edit-frame7-2" name="frame7-2" value="0" size="1" maxlength="1" class="form-text" readonly />
                  </div>
              </td>
              <td class="first score">
                  <div class="form-item form-type-textfield form-item-frame8-1">
                    <input type="text" id="edit-frame8-1" name="frame8-1" value="0" size="1" maxlength="1" class="form-text" readonly />
                  </div>
              </td>
              <td class="second score">
                  <div class="form-item form-type-textfield form-item-frame8-2">
                    <input type="text" id="edit-frame8-2" name="frame8-2" value="0" size="1" maxlength="1" class="form-text" readonly />
                  </div>
              </td>
              <td class="first score">
                  <div class="form-item form-type-textfield form-item-frame9-1">
                    <input type="text" id="edit-frame9-1" name="frame9-1" value="0" size="1" maxlength="1" class="form-text" readonly />
                  </div>
              </td>
              <td class="second score">
                  <div class="form-item form-type-textfield form-item-frame9-2">
                    <input type="text" id="edit-frame9-2" name="frame9-2" value="0" size="1" maxlength="1" class="form-text" readonly />
                  </div>
              </td>
              <td class="first score">
                  <div class="form-item form-type-textfield form-item-frame10-1">
                    <input type="text" id="edit-frame10-1" name="frame10-1" value="0" size="1" maxlength="1" class="form-text" readonly />
                  </div>
              </td>
              <td class="second score">
                  <div class="form-item form-type-textfield form-item-frame10-2">
                    <input type="text" id="edit-frame10-2" name="frame10-2" value="0" size="1" maxlength="1" class="form-text" readonly />
                  </div>
              </td>
              <td class="third score">
                  <div class="form-item form-type-textfield form-item-frame10-3">
                    <input type="text" id="edit-frame10-3" name="frame10-3" value="0" size="1" maxlength="1" class="form-text" readonly />
                  </div>
              </td>
              <td rowspan="2" class="game-result">
                  <div class="form-item form-type-textfield form-item-game-result">
                    <input type="text" id="edit-game-result" name="game_result" value="0" size="10" maxlength="3" class="form-text" readonly />
                  </div>
              </td>
            </tr>
            ...
            <tr>
              <td class="frame score" colspan="2">
                  <div class="form-item form-type-textfield form-item-frame1-res">
                    <input type="text" id="edit-frame1-res" name="frame1-res" value="0" size="3" maxlength="3" class="form-text" readonly />
                  </div>
              </td>
              <td class="frame score" colspan="2">
                  <div class="form-item form-type-textfield form-item-frame2-res">
                    <input type="text" id="edit-frame2-res" name="frame2-res" value="0" size="3" maxlength="3" class="form-text" readonly />
                  </div>
              </td>
              <td class="frame score" colspan="2">
                  <div class="form-item form-type-textfield form-item-frame3-res">
                    <input type="text" id="edit-frame3-res" name="frame3-res" value="0" size="3" maxlength="3" class="form-text" readonly />
                  </div>
              </td>
              <td class="frame score" colspan="2">
                  <div class="form-item form-type-textfield form-item-frame4-res">
                    <input type="text" id="edit-frame4-res" name="frame4-res" value="0" size="3" maxlength="3" class="form-text" readonly />
                  </div>
              </td>
              <td class="frame score" colspan="2">
                  <div class="form-item form-type-textfield form-item-frame5-res">
                    <input type="text" id="edit-frame5-res" name="frame5-res" value="0" size="3" maxlength="3" class="form-text" readonly />
                  </div>
              </td>
              <td class="frame score" colspan="2">
                  <div class="form-item form-type-textfield form-item-frame6-res">
                    <input type="text" id="edit-frame6-res" name="frame6-res" value="0" size="3" maxlength="3" class="form-text" readonly />
                  </div>
              </td>
              <td class="frame score" colspan="2">
                  <div class="form-item form-type-textfield form-item-frame7-res">
                    <input type="text" id="edit-frame7-res" name="frame7-res" value="0" size="3" maxlength="3" class="form-text" readonly />
                  </div>
              </td>
              <td class="frame score" colspan="2">
                  <div class="form-item form-type-textfield form-item-frame8-res">
                    <input type="text" id="edit-frame8-res" name="frame8-res" value="0" size="3" maxlength="3" class="form-text" readonly />
                  </div>
              </td>
              <td class="frame score" colspan="2">
                  <div class="form-item form-type-textfield form-item-frame9-res">
                    <input type="text" id="edit-frame9-res" name="frame9-res" value="0" size="3" maxlength="3" class="form-text" readonly />
                  </div>
              </td>
              <td class="frame score" colspan="3">
                  <div class="form-item form-type-textfield form-item-frame10-res">
                    <input type="text" id="edit-frame10-res" name="frame10-res" value="0" size="3" maxlength="3" class="form-text" readonly />
                  </div>
              </td>
            </tr>
          </table>
