n<%@ taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
...
<body>
  ...
  <div class="container">
    ...
    > <a href="/Exploration/user/profile">Profile</a> <br>
    ...
    <div class="container">
      <div class="jumbotron">
        ...
        <div id="userpref" style="display: none;">
          <form:form action="/Exploration/user/modify" method="POST"
            modelAttribute="user">
